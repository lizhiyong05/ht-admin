...
<template>
    <div class="clearfix">
        <h2 class="title-h2">试题详情</h2>
        <div class="preservation-container">
            <a ref="customDownload" :href="downloadURL" :download="downloadName" style="display: none"></a>
            <el-form :inline="true" size="small" :model="formData" class="demo-form-inline" label-width="100px" :rules="formRules"
                ...
                <el-form-item label="试题编号">
                    <el-input v-model="formData.qNumber" placeholder="" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="难度系数" prop="qDegree">
                    <el-select v-model="formData.qDegree" placeholder="" :disabled="true">
                        <el-option
                ...
                <el-form-item label="课程名称" prop="qCourseName">
                    <el-input v-model="formData.qCourse[0].courseName" placeholder="" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="考试地点" prop="qPoint">
                    <el-input v-model="formData.qPoint" placeholder="" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="试题内容" prop="qDesc">
                    ...
                    <el-upload v-if="['1', '2', '3', '5', '6'].includes(formData.qType)"
                    ...
                    <div v-if="['4'].includes(formData.qType)"
                         class="form-800item"
                    >
                        <p class="tips">tips：输入完整的题目后，选中需要填空的文字单击“设为空格”，双击按钮可取消空格</p>
                        <quill-editor
                                v-model="formData.qContent"
                ...
                <el-form-item
                    ...
                    <p v-if="['4', ].includes(formData.qType) && formData.qAlternative"
                       class="tips"
                    >
                        tips：重新设置空格时会清空备选数据
                    </p>
                    <p v-if="['4', ].includes(formData.qType) && !formData.qOrdered"
                       class="tips"
                    >
                ...
                <el-form-item label="选项" v-if="['1', '2', '3', '6'].includes(formData.qType)">
                    <div class="table-view" v-if="['1', '3', '6'].includes(formData.qType)">
                        ...
                        >
                            <draggable
                                    v-if="['1', '3', '6'].includes(formData.qType)"
                                    class="list-group"
                                    tag="ol"
        ...
        <div class="button-container">
            <el-button class="el-btn-min-100" size="small" type="primary" @click="$router.back()">返回</el-button>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                MAX_OPTION_PIC: 3,
                MAX_DES_PIC: 5,
                MAX_DES_VOICE: 1, // TODO ⭐原型及测试用例里均未有个数限制，先设为1
        ...
        methods: {
            ...
            customClick() {
                ...
                // if (this.editorSelect.blankCount > this.MAX_BLANK_COUNT - 1) {
                //     this.$notify({
                //         title: '数量超出',
                //         message: `当前空格${this.editorSelect.blankCount}个,最多${this.MAX_BLANK_COUNT}个`,
                //         type: 'warning',
                //         position: 'bottom-right'
                //     });
                //     // return;
                ...
                if (this.editorSelect.blankLength > this.MAX_BLANK_LENGTH) {
                    this.$notify({
                        title: '长度超出',
                        message: `当前选中长度${this.editorSelect.blankLength},最多${this.MAX_BLANK_LENGTH}`,
                        type: 'warning',
                        position: 'bottom-right'
                    });
                    return;
            ...
            handleExceed(files, fileList, flag) { //附件上传
                ...
                this.$message.warning(`当前限制上传 ${temMax} 个文件，本次选择了 ${files.length} 个文件，共选择了 ${files.length + fileList.length} 个文件`);
            },
            ...
            addOption() {
                if (this.formData.optionsData.length >= this.MAX_OPTION) {
                    this.$notify({
                        title: '提醒',
                        message: `最多只能有${this.MAX_OPTION}个选项`,
                        type: 'warning',
                        position: 'bottom-right'
                    });
                    return;
            ...
            onEditorChange(event) {
                ...
                if (this.editorSelect.blankCount > this.MAX_BLANK_COUNT) {
                    this.$notify({
                        title: '数量超出',
                        message: `空格最多${this.MAX_BLANK_COUNT}个`,
                        type: 'warning',
                        position: 'bottom-right'
                    });
                    this.editorSelect.blankCount = blanks.length;
